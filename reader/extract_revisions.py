...
class WikiRevisionHandler(xml.sax.ContentHandler):
  ...
  def endElement(self, tag):
    ...
    #  self.file_handle.write(self.tag_end('page'))
      ts_revs = zip(self.timestamps, self.revisions)
...
if __name__ == '__main__':
  ...
  arg_parser.add_argument('input_file', help='Input file (absolute path)')
  arg_parser.add_argument('output_file', help='Output file (absolute path)')
